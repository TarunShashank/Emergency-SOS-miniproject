...
<%-- 
    ...
    Created on : Jan 22, 2018, 6:02:52 PM
    Author     : tarun
--%>
...
<div class="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Financial Aid</a>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <form action="finsubmit.jsp" method="post">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="gender" name="gender" class=" btn dropdown-toggle form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="5" class="form-control" placeholder="Here can be your description" name="purpose"></textarea>
                                            </div>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-success btn-fill pull-right">Apply</button>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'pe-7s-gift',
            	message: "Fill this form for getting a loan"
