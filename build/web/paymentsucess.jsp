<%-- 
    ...
    Created on : Mar 7, 2018, 12:28:18 PM
    Author     : tarun
--%>
...
<body>
    ...
    <div id="Sucess" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-body" align="center">
        <p><img     src="https://png.icons8.com/cotton/40/000000/checkmark.png"></p>
        <p>
          Payment Sucessful
        </p>
        <a  type="button" class="btn btn-fill btn-round btn-sucess" href="supportmywork.jsp">OK</a>
      </div>
  </div>
</div>
        </div>
