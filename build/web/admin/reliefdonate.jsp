...
function del()
{
if(confirm("Do You Want to Delete this donataion item?"))
{
}
else
{
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Relief Donation List</h4>
                            </div>
                            <div class="card-body">
                         ...
                         ResultSet rs = st.executeQuery("select * from reliefdonate");
                                while(rs.next())
                                {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <form action="reliefdoante_del.jsp" method="get">
                                                        <input type="hidden" id="Donorid" name="don_id" value="<%=Did%>">
