                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Feedback Responses</h4>
                            </div>
                            <div class="card-body">
                         ...
                         ResultSet rs = st.executeQuery("select * from support");
                                while(rs.next())
                                {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <form action="support_del.jsp" method="get">
                                                        <input type="hidden" id="feedbackid" name="feed_id" value="<%=fid%>">
