<%-- 
    ...
    Created on : Mar 9, 2018, 12:15:34 PM
    Author     : tarun
--%>
...
<body class="">
     <%
            int count=0;
                         ...
                         ResultSet rs = st.executeQuery("select * from finaidapply");
        %>
    <div class="wrapper ">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> Finaicial Aid List</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                      <form action="finaidapply_del.jsp" method="get">
                                                        <input type="hidden" id="Donorid" name="apply_id" value="<%=aid%>">
